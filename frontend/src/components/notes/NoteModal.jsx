      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 mt-2">
        <div className="flex flex-col gap-1.5">
          ...
          <textarea
            ...
            disabled={saving}
            autoFocus
            className="w-full rounded-xl bg-slate-900/70 border border-slate-800 text-slate-100 text-sm placeholder:text-slate-500 p-3 focus:outline-none focus:ring-2 focus:border-indigo-500 focus:ring-indigo-500/20 resize-none"
          />
        </div>
