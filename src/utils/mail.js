...
const sendEmail = async (options) => {
  ...
  {
    console.error("Email service failed silently. Make surely that you have provided your MAILTRAP credentials in the .env file")
...
export {emailVerificationMailgenContent, forgotPasswordVerificationMailgenContent, sendEmail}